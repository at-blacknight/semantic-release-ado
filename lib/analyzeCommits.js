module.exports = async (pluginConfig, { lastRelease, logger }) => {
  ...
  if (setLastReleaseObjectVariables) {
    ...
    console.log(`##vso[task.setvariable variable=${lastReleaseVersionVarName};isOutput=${isOutput}]`)
    console.log(`##vso[task.setvariable variable=${lastReleaseGitHeadVarName};isOutput=${isOutput}]`)
    console.log(`##vso[task.setvariable variable=${lastReleaseGitTagVarName};isOutput=${isOutput}]`)
    console.log(`##vso[task.setvariable variable=${lastReleaseChannelVarName};isOutput=${isOutput}]`)
